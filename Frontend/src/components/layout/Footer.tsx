        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              {/* WhatsApp */}
              <a href="https://wa.me/9704502011" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center hover:opacity-80 transition-opacity">
